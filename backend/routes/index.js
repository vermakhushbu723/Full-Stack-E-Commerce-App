...
const {
  ...
  const { createOrder, handleWebhook } = require('../middleware/razorpay');
...
router.get('/filterCategory', authToken,getFilteredCategories);
...
router.post('/payment-callback', handleWebhook);
